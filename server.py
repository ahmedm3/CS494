...
def message_channels(sock, message, channels):
    """Function to broadcast chat messages to all connected clients

    this will send a message to all channels specified
...
def parse_data2(sock, message):
    ...
    if len(message) == 1:
        ...
        elif message[0] == '/message_channels': 
